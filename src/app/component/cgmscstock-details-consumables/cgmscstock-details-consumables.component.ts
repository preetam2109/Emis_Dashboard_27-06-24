...
@Component({
  selector: 'app-cgmscstock-details-consumables',
  templateUrl: './cgmscstock-details-consumables.component.html',
  styleUrls: ['./cgmscstock-details-consumables.component.css']
})
export class CgmscstockDetailsConsumablesComponent {
...
console.log(JSON.stringify(res))
  ...
  exportToPDF() {
    ...
    const title = 'Stock Details Consumables';
    ...
    doc.save('Stock_Details_Consumables.pdf');
  }
