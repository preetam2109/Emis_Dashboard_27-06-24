...
@Component({
  selector: 'app-growth-in-procurment',
  standalone: true,
  ...
  templateUrl: './growth-in-procurment.component.html',
  styleUrl: './growth-in-procurment.component.css'
})
export class GrowthInProcurmentComponent {
@ViewChild('chart') chart: ChartComponent | undefined;
  ...
  loadData(mcid:any,hodid:any,HOD:any): void {
    ...
    this.api.HODPOYear_AgAI(mcid,hodid,'N','N').subscribe(
      (data:any) => {
