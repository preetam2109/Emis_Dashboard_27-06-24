...
export class CardComponent implements OnInit {
  ...
  constructor(public hardcodedAuthemtication:HardcodedAuthenticationService,private cdr:ChangeDetectorRef,private breakpointObserver:BreakpointObserver,private route: Router, private rcapi: ApiService) {
    // this.chartOptions = {
    //   series: [],
    //   chart: {
    //     type: 'bar',
